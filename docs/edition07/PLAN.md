# Edition 07 — stronger model upgrade

Request: upgrade the model; 360M output is nonsense. Preserve the unnamed saucer, ASCII-only task, selectable browser compute and disclosed preview support.

- [x] Compare stronger checkpoints on ASCII subjects and save complete results.
- [x] Select Qwen3 4B and record pinned weights, examples and download costs. **Recognizable art is still inconsistent; size alone did not solve that concern.** See MODEL-ASSESSMENT.md.
