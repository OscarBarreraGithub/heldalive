...
model,tok=load(sys.argv[1] if len(sys.argv)>1 else '.local/edition03/model-q4')
...
Path('models/smollm2-360m-q4-v1/reference.json').write_text(json.dumps({'engine':'mlx-lm 0.31.3, mlx 0.32.2','cases':cases},indent=2))
